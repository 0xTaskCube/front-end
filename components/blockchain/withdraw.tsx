          ...
          <div className="mb-4">
            <Listbox value={selectedCoin} onChange={setSelectedCoin}>
              ...
              <div className="relative mt-2">
                ...
                <ListboxOptions className="absolute z-10 mt-1 max-h-56 w-full overflow-auto rounded-md bg-white py-1 text-base shadow-lg ring-1 ring-black  focus:outline-none sm:text-sm">
                  {coin.map((coin) => (
                    <ListboxOption
                      key={coin.id}
                      value={coin}
